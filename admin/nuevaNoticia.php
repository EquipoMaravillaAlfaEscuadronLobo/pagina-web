...
<?php 
    if (isset($_REQUEST['bandera'])) {
      ...
      $noticia->setId_administrador($idadmin->getId_administrador());
      
      
      $resultado=repositorio_noticia::regitrar(Conexion::obtener_conexion(), $noticia);
      if($resultado){
          echo '<script>';
          echo 'swal("Exito","Noticia Publicada","success")';
          echo '</script>';
      }else{
          echo '<script>';
